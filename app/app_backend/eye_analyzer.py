...
from .opencv_camera import Cv2Camera
...
class EyeAnalyzer(threading.Thread):
    ...
    def load(self):
        ...
        self.face_68_shape_detector = dlib.shape_predictor(Settings.MAIN_PATH + "/assets/dlib/shape_predictor_68_face_landmarks.dat")
        self.loading_status = 0.7
        self.eye_blink_keras_model = keras.models.load_model(Settings.MAIN_PATH + '/assets/trained_models/model_32_012-0.989.hdf5')
