...
class CTkProgressBar(tkinter.Frame):
    ...
    def draw(self):
        ...
        self.progress_parts.append(self.canvas.create_oval(
    ...
    def set(self, value):
        ...
        # change positions of progress parts
        self.canvas.coords(self.progress_parts[0],
                           self.border_width,
                           self.border_width,
                           self.height - self.border_width,
                           self.height - self.border_width)

        self.canvas.coords(self.progress_parts[1],
                           self.height / 2,
                           self.border_width,
                           self.height / 2 + (self.width - self.height) * self.value,
                           self.height - self.border_width)

        self.canvas.coords(self.progress_parts[2],
                           self.height / 2 + (self.width - self.height) * self.value - (
