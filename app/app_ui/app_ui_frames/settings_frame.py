...
class SettingsFrame(customtkinter.CTkFrame):
    def __init__(self, master, app=None, *args, **kwargs):
        ...
        self.volume_setting.place(relx=0.5, y=self.volume_setting_height, anchor=tkinter.N)
        ...
        self.time_setting.place(relx=0.5, y=self.time_setting_height, anchor=tkinter.N)
    ...
    def volume_setting_callback(self, value):
        self.volume_setting.slider_text.set_text("{}%".format(round(value*100)))
        self.app_pointer.volume_setting = value

    def time_setting_callback(self, value):
        self.time_setting.slider_text.set_text("{} sec.".format(round(value*30)))
    ...
    def set_time_setting(self, value):
        ...
        self.time_setting.slider_text.set_text("{} sec.".format(round(value)))
